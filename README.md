...
23. Поиск двух одинаковых строк/Поиск недостающих строк в файле с выводом массива с этими строками [Тест](tests/Tasks/Array/CompareFilesTest.php)
...
32. Вернуть значения из одного массива, которые содержатся во втором массиве, то есть разницу [Тест](tests/Tasks/Array/WithoutTest.php)
33. Рекурсивный алгоритм вывода элементов списка (Дерево) [Тест](tests/Tasks/Array/TreeTest.php)
